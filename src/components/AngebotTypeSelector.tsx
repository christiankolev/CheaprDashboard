...
export default function AngebotTypeSelector({ onSelect, betriebName, betriebCode, betriebBild }: AngebotTypeSelectorProps) {
  return (
    <div className="flex min-h-dvh flex-col bg-[#F5A200]">
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-5 py-4">
        ...
        <h1 className="mb-6 text-[2.2rem] font-black leading-tight tracking-tight text-cheapr-dark">
          Füge eine Lefty Box hinzu
        </h1>

        <button
          type="button"
          onClick={() => onSelect('Mini', 1)}
          style={{ backgroundColor: '#222222' }}
          className="relative flex w-full items-center justify-center rounded-3xl px-6 py-10 shadow-lg transition-all hover:opacity-90 active:scale-[0.98]"
        >
